...
class OAuthApi
{
     ...
     * @return \Aspose\Diagram\Cloud\Model\AccessTokenResponse
     */
     ...
     * @throws \Aspose\Diagram\Cloud\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Aspose\Diagram\Cloud\Model\AccessTokenResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function oAuthPostWithHttpInfo($grant_type, $client_id, $client_secret)
    {
        $returnType = '\Aspose\Diagram\Cloud\Model\AccessTokenResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Aspose\Diagram\Cloud\Model\AccessTokenResponse',
